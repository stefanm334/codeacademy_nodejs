...
import { getAllTracks, getSpecificTrack, createTrack,deleteTrack,updateTrack,getAllTracksForSpecifilUserAndAlbum,likeTrack,addTrackToPlaylist } from './actions.mjs';
...
router.post("/api/artist/:id/album/:albumid/track/:trackid/add",addTrackToPlaylist)
